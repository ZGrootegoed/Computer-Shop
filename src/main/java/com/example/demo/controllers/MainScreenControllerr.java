...
public class MainScreenControllerr {
 ...
 /*   public MainScreenControllerr(PartRepository partRepository, ProductRepository productRepository) {
    ...
    public String Success (@Param("btnBuyProduct") String btnBuyProduct, Model theModel){
        return "redirect:/successPurchase";
    }

    @GetMapping("/failPurchase")
    public String Fail (@Param("btnBuyProduct") String btnBuyProduct, Model theModel){
        return "redirect:/failPurchase";
    }
}
